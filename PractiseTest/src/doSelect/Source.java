...
-------------------
 class ArrayListOps:
 method definitions: 
 i)makeArrayListInt(int n): Method to create an arrayList with same number of elements as n and set elements to 0
      return type: ArrayList<Integer> 
      visibilty: public           
﻿
 ii)reverseList(ArrayList<Integer> list): Method to Reverse list
      return type: ArrayList<Integer>
      visibilty: public           

 iii)changeList(ArrayList<Integer> list, int m, int n): Method to change all occurences of m to n in list
      return type: ArrayList<Integer>
      visibilty: public   
...
public class Source
{
	public static void main(String[] args) 
	{
		...
		ArrayList<Integer> two=obj.reverseList(list);
		System.out.println(two);
		
		ArrayList<Integer> three=obj.changeList(list,28,20);
